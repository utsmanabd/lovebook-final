					...
					<div class="card p-4 rounded-5 shadow">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-center">
								<button type="submit" class="btn btn-danger mt-2" style="font-weight: 500; font-size: 14px; letter-spacing: 1px; display: inline-block;
                        padding: 12px 36px; border-radius: 50px; transition: 0.5s; background-color:#CE1212; color:white">Register</button>
							</div>
							<?= form_close() ?>
